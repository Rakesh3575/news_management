...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <a class="navbar-brand" href="{{ route('News.index') }}">{{ config('app.name') }}</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      @else
      <li class="nav-item">
        <a href="{{ route('News.create') }}" class="btn btn-success my-2 my-sm-0">Create Post</a>
      </li>
            ...
            <li class="list-group-item">
              <div class="d-flex justify-content-between">
                ...
                <div class="button-group d-flex">
                  <button type="button" class="btn btn-sm btn-primary mr-1 edit-category" data-toggle="modal" data-target="#editCategoryModal" data-id="{{ $category->id }}" data-name="{{ $category->name }}">Edit
                  </button>
